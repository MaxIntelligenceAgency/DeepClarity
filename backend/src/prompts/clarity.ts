...
- If both skills were selected: open with 1–2 sentences of mhgap-flavored literacy naming the phenomenon, then transition into the 29k three-beat arc. Keep total response under 180 words.
